...
INSERT INTO `preferences` (`id`, `title`, `description`, `valueType`) VALUES
(1, 'default_task', 'default task', 1),
(2, 'default_project', 'Default Project', 1);
...
INSERT INTO `projects` (`id`, `title`, `description`, `communityId`, `ownerId`, `type`, `categoryId`, `priority`, `status`, `startDateEstimate`, `startDateActual`, `endDateEstimate`, `endDateActual`, `timeRequiredEstimate`, `timeRequiredActual`, `percentComplete`, `active`) VALUES
(1, 'Project1', 'Project 1', 4, 1, 1, 0, 1, 2, '2016-04-02', '2016-04-03', '2016-04-04', '2016-04-05', '10.01', '15.02', '50.03', 0),
(2, 'Project2', 'Project2', 1, 1, 2, 0, 1, 1, '2016-04-01', '2016-04-01', '2016-04-01', '2016-04-01', '10.00', '15.00', '50.00', 1),
(3, 'User Personal', 'User\'s personal project', 1, 4, 1, 0, 1, 3, '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00', '0.00', '0.00', '0.00', 1);
...
(4, 'user_preference', 'User Preference Module', 'User', 'user_model', 'user_preference', 'user_preferences', 'id', '', '', '', ''),
...
(9, 'preferences', 'Preference Module', 'Preference', 'preference_model', 'preferences', 'preferences', 'id', '', '', '', ''),
(10, 'team', 'Team Module', 'Team', 'team_model', 'team', 'teams', 'id', '', '', '', ''),
(11, 'system_module', 'System Module Module', 'Module', 'system_model', 'system_module', 'system_modules', 'id', '', '', '', '');
...
(45, 'lookupType', 'lookupType', 4, 8, 'Lookup Type', 'Lookup Type', 0, 1, 1, 2, 1, 2, '0', 'tinyint(2)'),
(46, 'lookupTable', 'lookupTable', 5, 8, 'Lookup Table', 'Lookup Table', 0, 1, 1, 2, 2, 3, '', 'varchar(64)'),
(47, 'valueColumn', 'valueColumn', 6, 8, 'Value Column', 'Value Column', 0, 1, 1, 2, 3, 3, '', 'varchar(64)'),
(48, 'titleColumn', 'titleColumn', 7, 8, 'Title Column', 'Title Column', 0, 1, 1, 2, 4, 3, '', 'varchar(64)'),
...
(131, 'type', 'type', 9, 19, 'Type', 'Type', 0, 1, 5, 2, 15, 2, '0', 'tinyint(2)'),
(132, 'categoryId', 'categoryId', 10, 19, 'Category ID', 'Category', 0, 1, 5, 2, 16, 1, '0', 'int(11)'),
(133, 'priority', 'priority', 11, 19, 'Priority', 'Priority', 0, 1, 5, 2, 17, 2, '0', 'tinyint(1)'),
(134, 'startDateEstimate', 'startDateEstimate', 12, 19, 'Start Date Est.', 'Start Est.', 0, 1, 6, 2, 0, 5, '', 'date'),
(135, 'startDateActual', 'startDateActual', 13, 19, 'Start Date Act.', 'Start Act.', 0, 1, 6, 2, 0, 5, '', 'date'),
(136, 'endDateEstimate', 'endDateEstimate', 14, 19, 'End Date Est.', 'End Est.', 0, 1, 6, 2, 0, 5, '', 'date'),
(137, 'endDateActual', 'endDateActual', 15, 19, 'End Date Act.', 'End Act.', 0, 1, 6, 2, 0, 5, '', 'date'),
(138, 'dueDate', 'dueDate', 16, 19, 'Due Date', 'Due Date', 0, 1, 6, 2, 0, 5, '', 'date'),
(139, 'status', 'status', 17, 19, 'Status', 'Status', 0, 1, 1, 2, 18, 2, '0', 'tinyint(1)'),
(140, 'active', 'active', 18, 19, 'Active', 'Active', 0, 1, 8, 2, 0, 2, '0', 'tinyint(4)'),
(141, 'timeRequiredEstimate', 'timeRequiredEstimate', 19, 19, 'Time Req. Est.', 'Time Est.', 0, 1, 1, 2, 0, 4, '0', 'decimal(7,2)'),
(142, 'timeRequiredActual', 'timeRequiredActual', 20, 19, 'Time Req. Act.', 'Time Act.', 0, 1, 1, 2, 0, 4, '0', 'decimal(7,2)'),
...
(5, 'TaskHeader11', 'TH11', 1, 1, 1, 0, 1, 1, 1, 1, '2016-01-01', '2016-01-01', '2016-01-10', '2016-01-10', '2016-01-10', 1, 1, '10.00', '10.01'),
...
--
-- Dumping data for table `user_to_preferences`
--

INSERT INTO `user_to_preferences` (`userId`, `preferenceId`, `userModify`, `value`) VALUES
(1, 1, 0, '6'),
(4, 2, 0, 'project3');
