...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2016 at 09:09 PM
...
INSERT INTO `system_lookup_values` (`id`, `title`, `description`, `lookupId`, `value`) VALUES
...
INSERT INTO `system_table_columns` (`id`, `title`, `description`, `position`, `systemTableId`, `label`, `keyType`, `visible`, `lookupId`, `dataType`, `defaultValue`, `type`) VALUES
...
(106, 'valueType', 'valueType', 4, 16, 'Value Type', 0, 1, 9, 2, '0', 'tinyint(2)'),
...
(179, 'language', 'language', 12, 25, 'Language', 0, 1, 10, 3, '', 'varchar(20)'),
(180, 'timezone', 'Time Zone', 13, 25, 'Time Zone', 0, 1, 11, 3, '', 'varchar(20)'),
...
(193, 'valueType', 'valueType', 5, 26, 'Value Type', 0, 1, 9, 2, '0', 'tinyint(2)'),
...
(4, 'Fred User', 'Sample User', 'user', 'user', 3, 'Fred', 'User', 'fred@none.com', '415 555-1212', '415 555-1213', '48', '1', 2, 0, 0, 0, 1, '9_profile.jpg', '9_profile.jpg', 'halloween-1.jpg');
