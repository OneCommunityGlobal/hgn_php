...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2016 at 10:22 AM
...
INSERT INTO `system_modules` (`id`, `title`, `description`, `model`, `masterTable`, `masterTableCol`, `detailTable`, `detailTableCol`) VALUES
(1, 'project', 'Project Module', 'project_model', 'projects', 'id', 'tasks', 'projectId');
...
INSERT INTO `system_table_columns` (`id`, `title`, `description`, `position`, `systemTableId`, `label`, `colHeader`, `keyType`, `visible`, `displayType`, `displayWidth`, `lookupId`, `dataType`, `defaultValue`, `type`) VALUES
...
(52, 'lookupId', 'lookupId', 4, 9, 'Lookup ID', 'Lookup ID', 0, 1, 1, 2, 0, 1, '0', 'int(11)'),
...
(119, 'lookupId', 'lookupId', 9, 18, 'Lookup ID', 'Lookup ID', 0, 1, 1, 2, 0, 1, '0', 'int(11)'),
